   ...
   var preload = {
    ...
    audio: [
      '1Case.m4a',
      '10Wiretap.m4a',
      '13WiretapDisregard.m4a',
      '14Wireta Normative.m4a',
      '15WiretapNeutralize.m4a',
    ]
  };
  ...
  function saveData(){
    ...
    console.log("Data to be sent: ", data); // Log data for debugging
  ...
  var jsPsych = initJsPsych({
    ...
    on_finish: function() {
      saveData();
      if (successExp) {
        window.location.href = "https://app.prolific.co/submissions/complete?cc=11111111";
      }
    },
    });
  ...
  `,
    ...
    var distractors_story_1 = {
      type: jsPsychHtmlKeyboardResponse,
      stimulus: `
        <div class="case-instructions-container">
    ...
    var charge_screen = {
      type: jsPsychHtmlKeyboardResponse,
      stimulus: `
        <div style="text-align: center;" class="case-instructions-container">
          <p>Charge:</p>
    ...
    var eval_access_to_the_safe = {
      type: jsPsychHtmlKeyboardResponse,
      stimulus: `
        <div style="text-align: justify;" class="case-instructions-container">
      ...
      stimulus: `
        <div style="text-align: justify;">
          ...
          <ul style="text-align: left; margin-left: 50px;">
            ...
            <li>White car (car matching the defendants' seen speeding away)</li>
    ...
    var eval_safe_questions = {
      ...
      questions: [
        ...
        {
          prompt: "To what degree do you find it what this evidence means?",
          labels: ["1 (not at all)", "2", "3", "4", "5", "6", "7 (extremely)"],
          required: true
        },
        {
    ...
    var eval_car_questions = {
      type: jsPsychSurveyLikert,
      preamble: '<h3>4. White car (car matching the defendants&#39; seen speeding away)</h3>',
      questions: [
        {
          prompt: "How important is this evidence for determining the outcome of a legal case?",
          labels: ["1 (not at all)", "2", "3", "4", "5", "6", "7 (extremely)"],
    ...
    ///////
      ...
      var case_explain = {
        ...
        stimulus: `
        <div class="case-instructions-container">
          <p>Please imagine you are on jury duty, in a criminal case.</p>
          <p>You are asked to decide whether the defendant is <span style="color: #b3cf02; font-weight: bold;">guilty as charged.</span></p>
          <p style="margin-left: 40px;">
            If you are <span style="color: #b3cf02; font-weight: bold;">convinced</span> that Jason Wells has stolen the money, then you have to pronounce Jason Wells
             <span style="color: #b3cf02; font-weight: bold;">guilty</span>.
            <br><br>
            Otherwise, you have to pronounce Jason Wells <span style="color: #b3cf02; font-weight: bold;">not guilty</span>.
          </p>
          <p>In a criminal case, the defendant is protected by the presumption of innocence. The defendant should only be convicted if the evidence is so convincing that
           there is <span style="color: #b3cf02; font-weight: bold;">no "reasonable doubt"</span> that the person is guilty. Proof "beyond a reasonable doubt" is proof that 
           leaves the judge firmly convinced that the defendant is guilty. It is not required to prove guilt beyond all possible doubt. A "reasonable doubt" is a doubt 
           ...
           lack of evidence.</p>
          <p>If, after a careful and impartial consideration of all the evidence, you are <span style="color: #b3cf02; font-weight: bold;">not convinced beyond reasonable 
          doubt</span> that the defendant is guilty, it is your duty to find the defendant <span style="color: #b3cf02; font-weight: bold;">not guilty</span>. On the other
           hand, if, after a careful and impartial consideration of all the evidence, you are <span style="color: #b3cf02; font-weight: bold;">convinced beyond a reasonable
            doubt</span> that the defendant is guilty, it is your duty to find the defendant <span style="color: #b3cf02; font-weight: bold;">guilty</span>.</p>
          <br><br>
          <div class="continue-instructions">Press SPACE to continue</div>
        </div>
        `,  
      ...
      var decision_instructions = {
        ...
        stimulus: `
          <div style="text-align: justify; width: 66%; margin: auto;">
            <p>You will also be shown information on the screen that will represent the evidence.
            This information will stay on the screen until you make a decision. You can think about the evidence as long as you like, and reconsider the pieces of evidence presented.</p>
            <p>Afterwards, you should make a judgment. If you find the defendant guilty, press the "g" key on your keyboard.
            If you find the defendant not guilty, press the "n" key on your keyboard.
            We will remind you of the buttons to use when you get to the decision.</p>
            <p>If you understand these instructions, please proceed to the case now.</p>
            <br><br><br>
            <div class="continue-instructions">Press SPACE to continue</div>
          </div>
        `,
    ...
    var calibration_instructions = {
      ...
      choices: [' '], 
      on_load: function() {
        document.querySelector('.jspsych-content-wrapper').style.setProperty('background-color', 'grey');
      },  
      post_trial_gap: 1000
    };
    ...
    var trial_decision_reminder = {
      type: jsPsychHtmlKeyboardResponse,
      stimulus: `
        <div style="text-align: center;">
          <p>Let's get back to the actual task.</p>
          <p>Remember: you are asked to decide a criminal trial by finding the defendant guilty or not guilty.</p>
          <p>Your judgment should depend on whether their guilt is proven beyond a reasonable doubt.</p>
          <br><br><br>
          <div style="font-size: 18px;" class="continue-instructions">Press SPACE to continue</div>
        </div>
      `,
      choices: [' ']
    };
  ...
  var charge1_no_inadmissible_evidence = {
    ...
    prompt: `
      <div style="text-align: center;">
        <p id="jury_intro">You are now part of the jury deciding the case of Jason Wells that you read about in the first part of the study.</p>
        <p id="charge_heading">Charge:</p>
        <br><br><br>
        <p style="font-family: 'Times New Roman', Times, serif;" id="charge_details">Jason Wells is accused of having stolen $5,200 from the safe of his employer "Construction Ltd."</p>
        <br><br>
        <p style="font-family: 'Times New Roman', Times, serif;" id="call_to_decision">How would you decide the case?</p>
      </div>
    `,
    choices: "NO_KEYS",
    ...
    stimulus: `
          ...
          <div class="background">
            <table>
              ...
              <tr>
                <td id="bottom-left" class="bottom-left"></td>
                <td id=""></td>
                <td id="bottom-right" class="bottom-right"></td>
              </tr>
            </table>
          </div>
        `,
  ...
  var charge2_inadmissible_no_instructions = {
    type: jsPsychAudioKeyboardResponse,
    stimulus: '10Wiretap.m4a',
    prompt: `
      <div class="charge-container">
        <p id="jury_intro">You are now part of the jury deciding the case of Jason Wells that you read about in the first part of the study.</p>
        <p id="charge_heading">Charge:</p>
        <br><br><br>
        <p id="charge_details" style="font-family: 'Times New Roman', Times, serif;">Jason Wells is accused of having stolen $5,200 from the safe of his employer "Construction Ltd."</p>
        <br><br>
        <p id="additional_evidence_intro" style="font-family: 'Times New Roman', Times, serif;">In addition to the evidence presented to you earlier, there is now the following evidence introduced:</p>
        <p id="wiretap_evidence" class="case-instructions-container"><strong>Wiretap</strong><br>
        A police officer testifies: a call from Jason Wells' phone to his friend Alex Brown was recorded at 8:15 p.m. on the evening in question. The recording is played in court: 
        "Hey Alex, it's Jason. I did it! I finally stole the money. $5,200 cash, can you believe this? I went into the office, opened the safe, grabbed it, and took off. I really needed this, Alex. Now I can finally pay off this stupid loan first thing tomorrow."</p>
        <p id="call_to_decision" style="font-family: 'Times New Roman', Times, serif;">How would you decide the case?</p>
      </div>
    `,
    choices: "NO_KEYS",
    trial_ends_after_audio: true,
  ...
  var charge3_inadmissible_ignore = {
    type: jsPsychAudioKeyboardResponse,
    stimulus: '13WiretapDisregard.m4a',
    prompt: `
      <div class="charge-container">
        <p id="jury_intro">You are now part of the jury deciding the case of Jason Wells that you read about in the first part of the study.</p>
        <p id="charge_heading">Charge:</p>
        ...
        <br>
        <p id="additional_evidence_intro" style="font-family: 'Times New Roman', Times, serif;">In addition to the evidence presented to you earlier, there is now the following evidence introduced:</p>
        <div id="wiretap_evidence" class="case-instructions-container" style="width: 100%;">
          <p><strong>Wiretap</strong><br>
          A police officer testifies: a call from Jason Wells' phone to his friend Alex Brown was recorded at 8:15 p.m. on the evening in question. The recording is played in court: 
          "Hey Alex, it's Jason. I did it! I finally stole the money. $5,200 cash, can you believe this? I went into the office, opened the safe, grabbed it, and took off. I really needed this, Alex. Now I can finally pay off this stupid loan first thing tomorrow."</p>
          <p id="judge_instruction">When the audio recording of Jason Wells is played, the defense attorney protests. The judge agrees and tells the jury which you are part of:</p>
          <p id="ignore_instruction">"Information from illegal wiretaps is inadmissible. The jury will disregard the information from the phone call of Jason Wells to his friend."</p>
        </div>
        <p id="call_to_decision" style="font-family: 'Times New Roman', Times, serif;">How would you decide the case?</p>
      </div>
    `,
  ...
  var charge4_inadmissible_normative = {
    type: jsPsychAudioKeyboardResponse,
    stimulus: '14Wireta Normative.m4a',
    prompt: `
      <div class="charge-container">
        <p id="jury_intro">You are now part of the jury deciding the case of Jason Wells that you read about in the first part of the study.</p>
        <p id="charge_heading">Charge:</p>
        ...
        <p id="charge_details" style="font-family: 'Times New Roman', Times, serif;">Jason Wells is accused of having stolen $5,200 from the safe of his employer "Construction Ltd."</p>
        <p id="additional_evidence_intro" style="font-family: 'Times New Roman', Times, serif;">In addition to the evidence presented to you earlier, there is now the following evidence introduced:</p>
        <div id="wiretap_evidence" class="case-instructions-container" style="width: 100%; padding-top:0px; padding-bottom:0px">
          <p><strong>Wiretap</strong><br>
          A police officer testifies: a call from Jason Wells' phone to his friend Alex Brown was recorded at 8:15 p.m. on the evening in question. The recording is played in court: 
          "Hey Alex, it's Jason. I did it! I finally stole the money. $5,200 cash, can you believe this? I went into the office, opened the safe, grabbed it, and took off. I really needed this, Alex. Now I can finally pay off this stupid loan first thing tomorrow."</p>
          <p id="judge_instruction">When the audio recording of Jason Wells is played, the defense attorney protests. The judge agrees and tells the jury which you are part of:</p>
          <p id="normative_instruction">
            "Information from illegal wiretaps is inadmissible. The jury will disregard the information from the phone call of Jason Wells to his friend. It was recorded without a proper warrant, in a conversation that the defendant could reasonably expect to be private. As such, the interception of this communication constitutes a violation of the defendant's constitutional rights under the Fourth Amendment. All information contained in the wiretap should therefore not interfere with the question whether it has been proven that the defendant has committed the crime for which he is presently charged."
          </p>
        </div>
        <p id="call_to_decision" style="font-family: 'Times New Roman', Times, serif;">How would you decide the case?</p>
      </div>
  ...
  var charge5_inadmissible_neutralize = {
    type: jsPsychAudioKeyboardResponse,
    stimulus: '15WiretapNeutralize.m4a',
    prompt: `
      <div class="charge-container">
        <p id="jury_intro">You are now part of the jury deciding the case of Jason Wells that you read about in the first part of the study.</p>
        <p id="charge_heading">Charge:</p>
        ...
        <div id="wiretap_evidence" class="case-instructions-container" style="width: 100%; padding-top:0px; padding-bottom:0px">
          ...
          "Hey Alex, it's Jason. I did it! I finally stole the money. $5,200 cash, can you believe this? I went into the office, opened the safe, grabbed it, and took off. I really needed this, Alex. Now I can finally pay off this stupid loan first thing tomorrow."</p>
          <p id="judge_instruction">When the audio recording of Jason Wells is played, the defense attorney protests. The judge agrees and tells the jury which you are part of:</p>
          <p id="neutralize_instruction">
            "Information from illegal wiretaps is inadmissible. The jury will disregard the information from the phone call of Jason Wells to his friend. Please keep in mind that disregarding information that one has heard is difficult. In the interest of a fair trial, you must make an effort to prevent this information from biasing your judgement."
          </p>
        </div>
        <p id="call_to_decision" style="font-family: 'Times New Roman', Times, serif;">How would you decide the case?</p>
      </div>
  ...
  var case_evaluate_access_to_safe = {
    ...
    questions: [
      ...
      {
        prompt: "To what degree do you understand what this evidence means?",
        labels: ["1 (not at all)", "2", "3", "4", "5", "6", "7 (extremely)"],
        required: true
      },
      {
...
var success_guard = {
  ...
  function startExp() {
    ...
    timeline.push(case_explain);
    timeline.push(decision_instructions);
    ...
    timeline.push(trial_decision_reminder);
