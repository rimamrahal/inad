  ...
  class BinaryChoiceTableFourPlugin {
    ...
    trial(display_element, trial) {
      ...
      // display stimuli
        ...
        // var new_html = '';
        var table_stimulus =  ` <div id="div-table" style="display: flex; 
        ...
        font-size: 12px;
              ...
              <colgroup>
                  ...
                  <tr style="height:10%;>
                    <th style="vertical-align: top; ">'+readthis[0]+'</th>
                    <th style="vertical-align: top; ">'+readthis[0]+'</th>
                    <th style="vertical-align: top; ">'+readthis[0]+'</th>
                  </tr>
                ...
                <tr style="vertical-align: center; height: 40%;">
                    ...
                    <td style="text-align: center;  " id="bottom-right">${trial.payoffGroupTop ? trial.stimulus['random'].toFixed(0) : trial.stimulus['ingroup'].toFixed(0)}</td>
                </tr>
                  <tr style="height:10%;>
              <th style="vertical-align: bottom;  height: 25px;">${trial.stimulus ? 'Other gets' : 'You get'}</th>
              <th style="vertical-align: bottom; ">Option J: ${trial.payoffYouTop ? 'Other gets' : 'You get'}</th>
              <th style="vertical-align: bottom; ">${trial.payoffGroupTop ? 'Other´s Random Number' : 'Other in ' + globalgroup_text + '?'}</th>
              </tr>
